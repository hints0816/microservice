 ...
 *  @generated
 */
package com.hints.thrift.user;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.13.0)", date = "2020-12-27")
public class UserInfo implements org.apache.thrift.TBase<UserInfo, UserInfo._Fields>, java.io.Serializable, Cloneable, Comparable<UserInfo> {
  ...
  private static final org.apache.thrift.protocol.TField DI_FIELD_DESC = new org.apache.thrift.protocol.TField("di", org.apache.thrift.protocol.TType.I32, (short)1);
  ...
  private static final int __DI_ISSET_ID = 0;
  ...
  public void unsetDi() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __DI_ISSET_ID);
  }

  /** Returns true if field di is set (has been assigned a value) and false otherwise */
  public boolean isSetDi() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __DI_ISSET_ID);
  }

  public void setDiIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __DI_ISSET_ID, value);
  }
  ...
  public boolean equals(UserInfo that) {
    ...
    boolean this_present_di = true;
    boolean that_present_di = true;
  ...
  public int compareTo(UserInfo other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDi()).compareTo(other.isSetDi());
    if (lastComparison != 0) {
